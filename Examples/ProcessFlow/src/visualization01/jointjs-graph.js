...
export class Graph {
  constructor (htmlElement, diagramSize, gridSize, elementSizes, events, renderSwimlaneWatermarks, verticalSwimlanes, isEditable) {
    ...
    Shapes.defineShapes(gridSize, elementSizes, renderSwimlaneWatermarks, verticalSwimlanes, isEditable)
